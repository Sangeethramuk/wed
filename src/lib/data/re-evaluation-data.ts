...
export const STUDENTS: Record<string, StudentRecord> = {
  ...
  kavitha: {
    ...
    concern: 'Context missing', concernType: 'Context Gap', concernVariant: 'blue',
    evidence: 'Context Gap sheet',
    sv: '"My scores add up to 23 but total shows 21. C1: 8 + C2: 7 + C3: 8 = 23, not 21."',
    verdict: 'Context Gap issue · arithmetic mismatch flagged', vcolor: '#3B82F6',
