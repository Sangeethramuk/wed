...
export default function EvaluationOnboarding() {
 ...
 <div key={point} className="flex items-center gap-2.5 text-xs font-medium tracking-widest text-muted-foreground/80">
 ...
 <div className="flex items-center gap-8 py-6 px-12 rounded-full border border-border/50 bg-muted/20 backdrop-blur-md text-xs font-medium tracking-[0.3em] text-muted-foreground/60 shadow-sm">
