  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-700 pb-20">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
        {stats.map((stat, i) => (
          <Card key={stat.label} className="border-border/40 shadow-sm bg-card/50 backdrop-blur-sm group hover:border-primary/30 transition-all hover:-translate-y-1 overflow-hidden">
            ...
            <div className="space-y-3">
              <div className="flex gap-4 p-4 rounded-2xl border border-border/40 bg-card/40 backdrop-blur-sm group hover:border-amber-500/30 transition-all">
                ...
                <div className="space-y-1.5">
                  <p className="text-xs font-bold text-foreground italic">New Pattern Detected</p>
                  <p className="text-[11px] leading-relaxed text-muted-foreground/70 font-medium italic">60% of students in "Software Engineering" struggled with MVC Controller logic.</p>
                </div>
              </div>
              <div className="flex gap-4 p-4 rounded-2xl border border-border/40 bg-card/40 backdrop-blur-sm group hover:border-primary/30 transition-all">
                <div className="p-2.5 h-fit rounded-xl bg-primary/10 text-primary group-hover:scale-110 transition-transform">
                  <CheckCircle2 className="h-4.5 w-4.5" />
                </div>
                <div className="space-y-1.5">
                  <p className="text-xs font-bold text-foreground italic">Calibration Complete</p>
                  <p className="text-[11px] leading-relaxed text-muted-foreground/70 font-medium italic">Prompt strategy for "Database Systems" refined based on your grading style.</p>
                </div>
              </div>
            </div>
          </div>
