...
export default function DashboardPage() {
 ...
 <h1 className="text-3xl font-medium tracking-tight">Welcome, Professor</h1>
 ...
 <div className="flex justify-between text-xs font-medium tracking-wider text-muted-foreground">
