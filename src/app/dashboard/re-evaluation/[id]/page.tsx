...
export default function ReEvalWorkspacePage() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-2rem)] bg-slate-50/50 rounded-xl border border-border/10 overflow-hidden shadow-sm">
      ...
      <div className="flex flex-1 overflow-hidden min-h-0">
        ...
        <div className="flex-1 flex flex-col bg-slate-50/80 overflow-hidden relative">
          ...
          <div className="flex-1 overflow-y-auto p-8" style={{ scrollbarWidth: 'thin' }}>
            {view === 'scan' ? (
              <div className="max-w-2xl mx-auto rounded-xl bg-white border border-slate-200 shadow-xl shadow-slate-200/50 p-10 font-serif text-sm leading-[1.8] text-slate-800 relative ring-1 ring-slate-900/5">
              ...
              <div className="max-w-2xl mx-auto rounded-xl bg-slate-900 border border-slate-800 p-8 font-mono text-sm leading-relaxed text-slate-400">
          ...
          <div ref={rpScrollRef} className="flex-1 overflow-y-auto px-6 py-6 space-y-6" style={{ scrollbarWidth: 'thin' }}>
            {wsState === 'active' && (
              <>
                ...
                <section className="space-y-4">
                  ...
                  <div className="rounded-xl bg-white border border-slate-200 shadow-sm p-2 space-y-2">
                    <DecisionOption
                ...
                <section className="space-y-3">
                  ...
                  <div className="rounded-xl bg-white border-2 border-primary/20 shadow-sm p-5 space-y-4">
                    <div className="flex items-center justify-between">
            ...
            {wsState === 'compare' && (
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="rounded-xl p-6 bg-white border border-border/10 shadow-sm space-y-4">
                  <div className="flex items-center gap-3">
                    {comparing ? (
                ...
                {!comparing && (
                  <div className="rounded-xl border border-border/10 bg-white overflow-hidden shadow-sm">
            ...
            {wsState === 'submitted' && (
               <div className="flex flex-col items-center justify-center py-12 space-y-8 animate-in zoom-in-95 duration-500">
                  ...
                  <div className="w-full max-w-sm p-6 rounded-xl bg-white border border-border/10 shadow-sm space-y-4">
...
function CompareCard({ label, score, reason, variant }: { label: string; score: number; reason: string; variant?: 'primary' }) {
  ...
  return (
    <div className={`rounded-xl p-5 border ${isPrimary ? 'bg-primary/5 border-primary/20' : 'bg-slate-50 border-border/10'}`}>
