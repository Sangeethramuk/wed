...
export default function PreEvaluationPage() {
 ...
 <div className="flex items-center gap-6 text-xs font-medium tracking-[0.2em] transition-all">
 <div className="flex items-center gap-3">
 <span className="text-primary opacity-100 font-medium">Step {currentStep} of 5 — {currentStepData?.label}</span>
 </div>
 ...
 <div className="flex items-center gap-2 text-xs font-medium text-muted-foreground/30 tracking-widest">
