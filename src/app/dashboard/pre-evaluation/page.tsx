  ...
  return (
    <TooltipProvider delay={100}>
      <div className="flex flex-col min-h-[calc(100vh-8rem)] relative">
        <div className="sticky top-0 z-50 bg-background/60 backdrop-blur-md py-4 mb-8 border-b border-border/10">
          <div className="max-w-6xl mx-auto w-full px-4 flex items-center justify-between">
            <div className="eyebrow flex items-center gap-6">
              <span className="text-primary font-semibold">Step {currentStep} of 6 — {currentStepData?.label}</span>
              <div className="flex gap-2 text-muted-foreground/10">
                {steps.map(s => (
