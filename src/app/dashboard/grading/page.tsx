      ...
      <div className="max-w-6xl mx-auto">
        <header className="mb-12">
          <div className="flex items-center gap-2 text-muted-foreground mb-4">
            ...
            <span className="text-sm font-medium tracking-tight uppercase">Academic Evaluation Suite</span>
          </div>
                ...
                <Card className="h-full border border-slate-200/60 transition-all hover:border-slate-300 bg-white shadow-none rounded-xl overflow-hidden flex flex-column">
                  <div className="p-6 flex-1">
                    <div className="mb-6 flex justify-between items-start">
                      ...
                      <Badge variant="outline" className={`font-mono text-[10px] uppercase tracking-wider ${badgeColors[assignment.targetFix]}`}>
        ...
        <footer className="mt-20 pt-8 border-t border-slate-200/60">
          <div className="flex flex-col md:flex-row justify-between gap-8">
            <div className="max-w-xs">
              <h4 className="text-xs font-bold uppercase tracking-[0.2em] text-slate-400 mb-4 font-mono">Protocol Compliance</h4>
            ...
            <div className="flex gap-12">
              <div className="text-center md:text-left">
                ...
                <div className="text-[10px] font-bold uppercase tracking-widest text-slate-400 font-mono">Systemic Fixes</div>
              </div>
              <div className="text-center md:text-left">
                <div className="text-2xl font-light text-slate-900">12++</div>
                <div className="text-[10px] font-bold uppercase tracking-widest text-slate-400 font-mono">Integrity Signals</div>
              </div>
            </div>
          </div>
        </footer>
