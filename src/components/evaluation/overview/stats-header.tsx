...
export function StatsHeader({ total, pendingCalibration, inGrading, complete }: StatsHeaderProps) {
 ...
 <p className="text-xs font-medium tracking-[0.2em] text-muted-foreground/60">{stat.label}</p>
 <p className={`text-4xl font-medium tracking-tighter tabular-nums ${stat.color}`}>{stat.value}</p>
 </div>
