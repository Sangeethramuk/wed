            ...
            <div className="flex flex-col h-full border-r border-border">
              <div className="p-4 border-b border-border space-y-4 shrink-0">
                <div className="flex items-center justify-between">
                  <h2 className="font-medium text-[10px] uppercase tracking-[0.2em] text-muted-foreground/80">
                    Blind Queue
                  </h2>
                      ...
                      >
                        <div className="flex items-center gap-2.5 flex-1 min-w-0">
                          ...
                          <div className="flex flex-col gap-0.5 min-w-0">
                            <span className={`font-medium tracking-tight text-[11px] uppercase tracking-widest truncate ${isActive ? "text-primary" : "text-foreground/70"}`}>
                              {paper.anonymizedLabel}
                            </span>
                            <span className="text-[9px] font-medium text-muted-foreground/40 uppercase tracking-widest tabular-nums">
                              Paper {idx + 1}
                            </span>
                          </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className="flex flex-col">
                      <span className="text-[9px] font-medium uppercase tracking-[0.2em] text-primary/60 mb-0.5">
                        Blind Manuscript
                      </span>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex items-center gap-3 px-5 py-2 bg-accent/40 rounded-full border border-border/50 text-[9px] font-medium uppercase tracking-widest text-muted-foreground/60 transition-all cursor-default">
                      <Tooltip>
              ...
              >
                ...
                >
                  <div className="absolute top-8 left-8 flex flex-col items-start gap-1">
                    <span className="text-[8px] font-medium uppercase tracking-[0.3em] text-primary/40 group-hover/page:text-primary transition-colors">Blind Calibration</span>
                    <span className="text-[10px] font-medium uppercase tracking-widest text-[#E6E1D6] group-hover/page:text-slate-400 transition-colors">Digital Manuscript</span>
                  </div>
                      ...
                      <div className="space-y-12">
                        {criteria.map((criterion, idx) => (
                          <div key={criterion.id} className="space-y-6">
                            <h2 className="text-xl font-medium italic border-l-2 border-amber-500 pl-4 tracking-tight text-slate-800 flex items-center gap-3">
                              <span className="text-[11px] font-medium uppercase tracking-[0.2em] text-amber-500/80 not-italic shrink-0">
                      ...
                      {hasScrolledToBottom && (
                        <div className="pt-20 pb-8 shrink-0 w-full flex items-center justify-center opacity-40 hover:opacity-100 transition-opacity">
                            <div className="flex flex-col items-center gap-4">
                              ...
                              <span className="text-[10px] font-medium uppercase tracking-[0.5em] text-muted-foreground">End of Submission</span>
                            </div>
                        </div>
                      )}
                    </div>
          ...
          <ResizablePanel defaultSize={30} minSize={20}>
            <div className="h-full flex flex-col border-l border-border bg-background">
              ...
              <div className="px-4 py-3 border-t border-border bg-background shrink-0 space-y-2">
                {isLastCriterion && (
                  <div className="flex items-center justify-between text-[9px] font-medium uppercase tracking-widest text-muted-foreground/40 pb-1">
                      ...
                      <Tooltip>
                        ...
                        {!isGateUnlocked && (
                          <TooltipContent className="max-w-xs p-3 space-y-1 mb-2">
                            <p className="font-medium text-xs uppercase tracking-widest text-primary">Protocol Gate Locked</p>
