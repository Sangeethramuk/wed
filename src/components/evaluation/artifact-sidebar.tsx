...
function ArtifactPreviewDialog({
 ...
 <span className="text-xs font-medium text-white/50 tracking-widest">Video Preview</span>
...
export default function ArtifactSidebar({
 ...
 <span className="text-xs font-medium tracking-widest text-muted-foreground truncate">
 ...
 <Badge
 variant="outline"
 className="h-5 w-5 p-0 flex items-center justify-center text-xs font-medium rounded-full mx-auto"
 >
 {totalCount}
 </Badge>
 )}
 ...
 {artifact.isPrimary && (
 <Badge className="h-4 px-1 rounded text-xs font-medium bg-primary text-primary-foreground shrink-0">
 PRIMARY
 </Badge>
 )}
 </div>
