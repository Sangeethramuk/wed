...
export function CalibrationConfirm() {
 ...
 <h1 className="text-3xl font-medium tracking-tight secondary-text ">Preparing your digital desk</h1>
 <p className="text-xs font-semibold text-muted-foreground/40 tracking-widest leading-none">Confirm your strategy and publish the assignment.</p>
 </div>
 </div>
 ...
 <span className="font-medium tracking-widest text-xs">Verified Strategy</span>
 </div>
 <CardTitle className="mt-4 text-3xl font-medium secondary-text tracking-tighter">Based on your past results</CardTitle>
 ...
 <span className="text-xs font-medium tracking-widest opacity-40 group-hover:opacity-100 transition-opacity">Institutional Alignment</span>
 </div>
 <span className="text-lg font-medium text-emerald-600 tracking-tighter">98% Match</span>
 </div>
 </CardContent>
 </Card>
 ) : (
 ...
 <span className="font-medium tracking-widest text-xs">New Environment</span>
 </div>
 <CardTitle className="mt-4 text-3xl font-medium secondary-text tracking-tighter">Ready to start grading?</CardTitle>
 <CardDescription className="text-base font-semibold opacity-60 leading-relaxed mt-2">
 ...
 <div className="px-3 py-1 rounded-md text-xs font-medium bg-amber-100 text-amber-700 mt-1 tracking-widest">Option 1</div>
 <div className="space-y-1 flex-1">
 <p className="text-lg font-medium tracking-tight">Interactive Calibration</p>
 ...
 <div className="px-3 py-1 rounded-md text-xs font-medium bg-muted text-muted-foreground mt-1 tracking-widest">Option 2</div>
 <div className="space-y-1 flex-1">
 <div className="flex items-center justify-between">
 <p className="text-lg font-medium tracking-tight">Expert Reference Sheet</p>
 </div>
 ...
 <Button variant="link" className="p-0 h-auto text-xs font-medium text-primary tracking-widest mt-2 hover:no-underline group-hover:translate-x-1 transition-transform">Upload key →</Button>
 </div>
 </div>
 </CardContent>
 </Card>
 ...
 <p className="text-xs font-medium tracking-widest text-muted-foreground opacity-30">Assignment Scope</p>
 <p className="text-sm font-medium tracking-tight secondary-text">Multiple Files (Artifacts)</p>
 </CardContent>
 </TooltipTrigger>
 ...
 <TooltipTrigger className="border border-border/20 rounded-2xl overflow-hidden shadow-none bg-muted/[0.02] hover:bg-white transition-all hover:border-primary/20 cursor-help">
 <CardContent className="pt-6 pb-6 px-6 space-y-2">
 <p className="text-xs font-medium tracking-widest text-muted-foreground opacity-30">Framework Mapping</p>
 <p className="text-sm font-medium tracking-tight secondary-text">3 Linked CO-POs</p>
 </CardContent>
 </TooltipTrigger>
 ...
 <TooltipTrigger className="border border-border/20 rounded-2xl overflow-hidden shadow-none bg-muted/[0.02] hover:bg-white transition-all hover:border-primary/20 cursor-help">
 <CardContent className="pt-6 pb-6 px-6 space-y-2">
 <p className="text-xs font-medium tracking-widest text-muted-foreground opacity-30">Class Size</p>
 <p className="text-sm font-medium tracking-tight secondary-text">~45 Students</p>
 </CardContent>
 </TooltipTrigger>
 ...
 <Button variant="ghost" className="px-8 text-xs font-medium tracking-widest opacity-40 hover:opacity-100 h-14 rounded-xl transition-all" onClick={reset}>Save as draft</Button>
 <Button size="lg" className="h-14 px-12 text-lg font-medium tracking-tight rounded-xl shadow-none active:scale-95 transition-all bg-primary hover:bg-primary/90 gap-4" onClick={nextStep}>
