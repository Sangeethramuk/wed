...
export function AuditSidebar() {
 ...
 return (
 <Sheet>
 <SheetTrigger className="inline-flex items-center justify-center rounded-lg border border-border/20 bg-background/30 backdrop-blur-sm px-3 h-8 text-xs font-medium tracking-widest hover:bg-muted/50 gap-2 transition-all active:scale-95 shadow-none">
 ...
 <SheetTitle className="text-2xl font-medium tracking-tight secondary-text">
 Audit
 </SheetTitle>
 <p className="text-xs font-semibold text-muted-foreground/40 leading-relaxed tracking-widest">
 ...
 <h4 className="text-xs font-medium tracking-tight text-foreground/60">{event.action}</h4>
 <span className="text-xs text-muted-foreground/30 font-medium tracking-widest bg-muted/20 px-1.5 py-0.5 rounded border border-border/10">{event.timestamp}</span>
 </div>
 <p className="text-xs text-muted-foreground/50 font-medium leading-relaxed pr-4">{event.details}</p>
 <div className="flex items-center gap-2">
 <Badge variant="outline" className={`text-xs tracking-widest py-0 px-2 font-medium border border-border/20 bg-transparent opacity-30 rounded-full h-4`}>
 {event.type}
 </Badge>
 </div>
 </div>
 ...
 <p className="text-xs font-medium text-primary/30 tracking-widest">
 Secure Log
 </p>
